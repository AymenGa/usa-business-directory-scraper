"""
Electronics / Gadgets — Etsy shop profile enricher (directory data).
Visits each unique shop page to extract location, rating, icon.
Creates Directory rows (10 columns) from Etsy shop profiles.

Run:
  python scraper/electronics/etsy_shops.py --test   # first 10 shops
  python scraper/electronics/etsy_shops.py          # all shops
"""
...
# ── Main ─────────────────────────────────────────────────────────────────────
def main():
    parser = argparse.ArgumentParser(description="Electronics / Gadgets — Etsy shop enricher")
