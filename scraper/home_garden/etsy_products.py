"""
Home and Garden — Etsy product scraper (marketplace data).
...
Run:
  python scraper/home_garden/etsy_products.py --test   # 1 state, 25 rows
  python scraper/home_garden/etsy_products.py          # all 50 states
"""
...
def main():
    parser = argparse.ArgumentParser(description="Home and Garden — Etsy product scraper")
